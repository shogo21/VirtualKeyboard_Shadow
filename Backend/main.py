...
sh_frameid_from_unity = SharedData("frameid_from_unity")
...
keyinfo_receiver = KeyInfoReceiver(sh_frameid_from_unity)
image_sender.start()
...
detector = TouchDetector(sh_image_and_landmarks, sh_touches, sh_framebuffer, sh_frameid_from_unity)
tracker.start()
detector.start()
